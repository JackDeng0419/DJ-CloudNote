...
<div class="wrapper">
    <div id="box">
        ...
        <div id="tabcon">
            <div class="box show">
<%--                action="user" means that once this form is submitted, the url becomes ..../user --%>
                <form action="user" method="post" id="loginForm">
                    <%--  actionName表示随表单提交用户行为，servlet根据此actionName决定调用什么行为                     --%>
                    ...
                    <input name="rem" type="checkbox" value="1"  class="inputcheckbox"/> <label>记住我</label>&nbsp; &nbsp; <span id="msg" style="color: red;font-size: 12px;">${resultInfo.msg}</span><br /><br />
